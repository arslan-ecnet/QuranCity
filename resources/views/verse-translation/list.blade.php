@extends('layouts.app')
@section('title')
    <title>Verse Translations</title>
@endsection
@section('content')
    <style>
    ...
    <div class="dash-content">
        ...
        <div class="content-table">
            <div class="mb-4">
                <h5>Verse Translations</h5>
            </div>
            <a href="{{route('verseTranslationCreate')}}" class="btn btn-info text-white mb-3"
                style="background-color: #CAAE78;border-color: #CAAE78">Create Verse Translation</a>
        ...
        $(document).ready(function () {
            if (!$.fn.DataTable.isDataTable('#dataTable')) {
                $('#dataTable').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "{{ route('verseTranslationList') }}",
                        "type": "GET"
                    },
                    "pageLength": 10,
                    "order": [[0, "asc"]],
