...
@section('content')
    ...
    <div class="dash-content">
        ...
        <div class="content-table">
            <div class="mb-4"><h5>Translations</h5></div>
            <a href="{{route('translationCreate')}}" class="btn btn-info text-white mb-3"
               style="background-color: #CAAE78;border-color: #CAAE78">Create Translation</a>
