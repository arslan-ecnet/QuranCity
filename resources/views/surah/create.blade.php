            ...
            <div class="content-wrap box-content box-shadow p-4 p-md-5">
                <div class="row top-content">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control" name="name_transliteration">
                    </div>
                </div>
                ...
                <div class="row top-content mt-4">
                    <div class="col-lg-3">
                        <label>Rukus</label>
                        <input type="number" class="form-control" name="rukus">
                    </div>
                    <div class="col-lg-3">
                        <label>Hizb Number</label>
                        <input type="number" class="form-control" name="hizb_number">
                    </div>
                    <div class="col-lg-3">
                        <label>Juz Start</label>
                        <input type="number" class="form-control" name="juz_start">
                    </div>
                    <div class="col-lg-3">
                        <label>Juz End</label>
                        <input type="number" class="form-control" name="juz_end">
                    </div>
                </div>
